...
set_property PACKAGE_PIN[get_ports led_en]
set_property IOSTANDARD LVCMOS15[get_ports led_clk]
set_property IOSTANDARD LVCMOS15[get_ports led_do]
set_property IOSTANDARD LVCMOS15[get_ports led_en]
set_property PACKAGE_PIN M24[get_ports seg_clk]
set_property PACKAGE_PIN[get_ports seg_do]
set_property PACKAGE_PIN[get_ports seg_en]
set_property IOSTANDARD LVCMOS15[get_ports seg_clk]
set_property IOSTANDARD LVCMOS15[get_ports seg_do]
set_property IOSTANDARD LVCMOS15[get_ports seg_en]